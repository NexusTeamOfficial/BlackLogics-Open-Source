...
public class DesignDrawer extends LinearLayout implements View.OnClickListener {
    ...
    public final void a(Context context) {
        ...
        /* Add Resource Encrypt Manager*/
        menusLayout.addView(addDrawerItem(
        22,
        false,
        R.drawable.ic_encrypt_48dp,
        R.string.design_drawer_menu_resource_encrypt,
        R.string.design_drawer_menu_resource_encrypt_subtitle
        ));
        ...
        23,
        false,
        R.drawable.icon_security_outline,
        R.string.design_drawer_menu_dex_encrypt,
        R.string.design_drawer_menu_dex_encrypt_subtitle
        ));
        ...
        R.string.design_drawer_menu_logcat,
        R.string.design_drawer_menu_logcat_subtitle));
    }
        ...
        if (!mB.a()) {
            if (context instanceof DesignActivity) {
                ...
                switch ((Integer) view.getTag()) {
                    ...
                    case 13:
                    designActivity.toManifestEditor();
                    return;
                    ...
                    designActivity.toEncryptManager();
                    return;
                    
                    case 23:
                    designActivity.toEncryptDex();
                    return;
