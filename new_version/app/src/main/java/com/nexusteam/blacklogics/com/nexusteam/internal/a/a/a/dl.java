...
public class dl {
    ...
    public static int a(float f, int i, int i2) {
        ...
        float b6 = b3 + (f * (b(((float) (i2 & 255)) / 255.0f) - b3));
        return (Math.round(a(b + ((b4 - b) * f)) * 255.0f) << 16) | (Math.round((f2 + (((((float) ((i2 >> 24) & 255)) / 255.0f) - f2) * f)) * 255.0f) << 24) | (Math.round(a(b2 + ((b5 - b2) * f)) * 255.0f) << 8) | Math.round(a(b6) * 255.0f);
    }
}
