...
public class aq {
    ...
    public aq setPackageName(String name) {
        this.packageName = name;
        return this;
    }
    
    public aq setAppName(String name) {
        this.appName = name;
        return this;
    }
    
    public aq setAppIcon(String icon) {
        this.appIcon = icon;
        return this;
    }
    
    public aq setThemeColor(String color) {
        this.themeColor = color;
        return this;
    }
    
    public aq setAndroidX(boolean enable) {
    ...
    public aq addActivity(String name, Map<String, String> attrs) {
    ...
    public aq addService(String name, Map<String, String> attrs) {
    ...
    public aq addReceiver(String name, Map<String, String> attrs) {
    ...
    public aq addPermission(String name) {
        if (!permissions.contains(name)) permissions.add(name);
        return this;
    }
    
    public aq setAttribute(String key, String value) {
    ...
    public aq addLauncherActivity(String name) {
    ...
    public aq autoRegisterActivities(String sc_id) {
    try {
        ...
        for (String fullName : list) {
            ...
            // 👉 class name nikal (last part)
            String className = fullName.substring(fullName.lastIndexOf(".") + 1);

            // 👉 manifest format: .ClassName
            ...
            addActivity(manifestName, attrs);
        }
