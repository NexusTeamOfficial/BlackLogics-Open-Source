...
public class BlocksManageCreatorActivity extends AppCompatActivity {
	...
	private MaterialCardView cardv;
	...
	private MaterialButton select_type;
	private TextInputEditText type;
	private TextInputEditText type_name;
	...
	private MaterialButton colour_selector;
	private TextInputEditText color;
	private TextInputEditText spec;
	private LinearLayout parametersHolder;
	private TextInputEditText spec2;
	...
	private MaterialButton closeTipsBtn;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		closeTipsBtn = findViewById(R.id.closeTipsBtn);
		...
		select_type.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				new AlertDialog.Builder(BlocksManageCreatorActivity.this)
				.setTitle("Block type")
				.setSingleChoiceItems(
				choices.toArray(new String[0]),
				types.indexOf(type.getText().toString()),
				new DialogInterface.OnClickListener() {  // Anonymous inner class instead of lambda
					@Override
				...
				.setPositiveButton(R.string.common_word_save, new DialogInterface.OnClickListener() {
					@Override
	...
	private View addBlockMenu(final String menu, String name) {
		...
		textView.setPadding(
		(int) BlackLogicsUtil.getDip(this, 8),
		0,
		(int) BlackLogicsUtil.getDip(this, 8),
		0
		);
