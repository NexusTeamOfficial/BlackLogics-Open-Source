package com.nexusteam.sdk.jbk.util;
...
public class LogUtil {
    ...
    public static void log(String tag, String prefixIfOneLiner, String logMessageIfMultipleLines,
    ...
    public static void log(
        String tag, String prefixIfOneLiner, String logMessageIfMultipleLines, String toLog) {
        if (toLog.length() > 1023) {
            ArrayList<String> loggableStrings = new ArrayList<>();
            int beginIndex = 0;
            while (beginIndex < (toLog.length() - (toLog.length() % 1024))) {
    ...
    public static void dump(String tag, Object obj) {
        ...
        log(tag, "Dumping a L" + obj.getClass().getCanonicalName().replace(".", "/") + ": ",
            "Dumping a L" + obj.getClass().getCanonicalName().replace(".", "/")
                + " over multiple lines because of message length: ",
            toLog.toString());
    }
    ...
    public static String dump(Object object) {
        ...
        while (index < fields.length) {
            ...
            dump.append(current.getName()).append("=");
            ...
            try {
                ...
                if (fieldAsObject == null) {
                    ...
                    if (fieldAsObject instanceof String) {
                        dump.append("\"").append((String) fieldAsObject).append("\"");
