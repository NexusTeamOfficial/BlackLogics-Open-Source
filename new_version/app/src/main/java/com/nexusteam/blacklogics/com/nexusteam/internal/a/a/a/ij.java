...
public class ij extends AppCompatTextView implements hq {
    ...
    public void a(Context context) {
        ...
        this.f297a = new Paint(1);
        this.f297a.setColor(-1785080368);
    ...
    public void onDraw(Canvas canvas) {
        if (this.c) {
            canvas.drawRect(new Rect(0, 0, getMeasuredWidth(), getMeasuredHeight()), this.f297a);
        }
        super.onDraw(canvas);
    }
}
