...
public class ProguardHandler {
    ...
    public ProguardHandler(String sc_id) {
        ...
        config_path = FileUtil.getExternalStorageDir() + "/.blacklogics/data/" + sc_id + "/proguard";
        fm_config_path = FileUtil.getExternalStorageDir() + "/.blacklogics/data/" + sc_id + "/proguard_fm";
    ...
    private static String createAndroidRules() {
        String rulePath = FileUtil.getExternalStorageDir() + "/.blacklogics/libs/android-proguard-rules.pro";
    ...
    private static String createDefaultRules(String sc_id) {
        String path = FileUtil.getExternalStorageDir() + "/.blacklogics/data/" + sc_id + "/proguard-rules.pro";
