...
public class ComponentFragmentActivity extends Fragment {
	...
	public void c() {
		List<HashMap<String, String>> components = DesignActivity.loadComponentLogic(DesignActivity.abc.currentActivityBean.getActivityName());
		componentData.clear();
	...
	private void showComponentDetailsDialog(ComponentData component) {
		...
		saveButton.setOnClickListener(v -> {
			...
			if (fieldName.isEmpty()) {
				...
				DesignActivity.abc.currentActivityBean.getActivityName(),
				component.getName(),
				fieldName
				);
	...
	private void handleEventSelection(String componentName, String fieldName, String eventName) {
		...
		intent.putExtra("activityName", DesignActivity.abc.currentActivityBean.getActivityName());
		...
		public void onBindViewHolder(ViewHolder _holder, final int _position) {
			...
			baseComponentDeleteUi.setOnClickListener(v -> {
				...
				.setPositiveButton("Remove", (dialog, which) -> {
					String activityName = DesignActivity.abc.currentActivityBean.getActivityName();
			...
			for (String event : events) {
				...
				// Click listener
				eventButton.setOnClickListener(v -> handleEventSelection(componentName, fieldName, event));
