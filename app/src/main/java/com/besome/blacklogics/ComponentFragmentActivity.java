...
public class ComponentFragmentActivity extends Fragment {
	...
	public void c() {
		...
		List<HashMap<String, String>> components = Qf.loadComponentLogic(ProjectDataHelper.getActivityName(getContext().getApplicationContext()));
		componentData.clear();
	...
	private void showComponentDetailsDialog(ComponentData component) {
		...
		saveButton.setOnClickListener(v -> {
			...
			if (fieldName.isEmpty()) {
				...
				ProjectDataHelper.getActivityName(getContext().getApplicationContext()),
				component.getName(),
				fieldName
				);
