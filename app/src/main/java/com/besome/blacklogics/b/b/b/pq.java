...
/**
 * pq - Encryption utility (AES, PBKDF2). Produces binary output: SALT(16) || IV(16) || CIPHERTEXT.
 */
public class pq {
    ...
    // Generate SecretKey from password + salt
    ...
    // Encrypt plaintext bytes and write binary file: [salt(16)][iv(16)][ciphertext]
    public static void encryptToFile(File outFile, byte[] plainBytes, char[] password) throws Exception {
        ...
        // write salt + iv + ciphertext directly (binary)
    ...
    // Read file with format salt||iv||cipher and return decrypted bytes
