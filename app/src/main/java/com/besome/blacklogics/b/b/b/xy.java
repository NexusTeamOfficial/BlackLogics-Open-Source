...
public class xy extends MaterialAlertDialogBuilder {
    ...
    private View createDialogView(Context context) {
        ...
        TextInputEditText minSdkInput = new TextInputEditText(context);
        ...
        TextInputEditText targetSdkInput = new TextInputEditText(context);
        ...
        TextInputEditText appNameInput = new TextInputEditText(context);
        appNameInput.setText(".BlackApplication");
        appNameLayout.addView(appNameInput);
        root.addView(appNameLayout);

        MaterialCheckBox cbViewBinding = createCheckBox(context, "Enable ViewBinding");
        MaterialCheckBox cbDeprecated = createCheckBox(context, "Remove old deprecated methods");
        MaterialCheckBox cbMaterial = createCheckBox(context, "Use MaterialComponents");
      ...
      //  root.addView(cbViewBinding);
       // root.addView(cbDeprecated);
      //  root.addView(cbMaterial);
