...
public class ManageLocalLibraryActivity extends Activity implements View.OnClickListener, LibraryDownloader.OnCompleteListener {
    ...
    private void loadFiles() {
        ...
        local_lib_file = FileUtil.getExternalStorageDir().concat("/.blacklogics/data/").concat(sc_id.concat("/local_library"));
    ...
    public class LibraryAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ((ImageView) convertView.findViewById(R.id.img_delete)).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
