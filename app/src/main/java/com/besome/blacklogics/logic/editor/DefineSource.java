...
public class DefineSource {
    ...
    public static final String[] MENU_ACTION_FIELD = new String[]{"SHOW_AS_ACTION_ALWAYS", "SHOW_AS_ACTION_COLLAPSE_ACTION_VIEW", "SHOW_AS_ACTION_IF_ROOM", "SHOW_AS_ACTION_NEVER", "SHOW_AS_ACTION_WITH_TEXT"};
