...
public class BlockArg extends BlockBase {
	...
	public BlockArg(Context var1, String var2, int var3, String var4) {
		...
		if (ProjectDataHelper.getActivityName(var1) != null) {
			widgetHelper = new xr("/storage/emulated/0/.blacklogics/data/" + ProjectDataHelper.getScId(var1), ProjectDataHelper.getActivityName(var1));
	...
	private void showColorPopup() {
		// Parse initial color from argValue safely
		...
		if (var2 != null) {
			...
			// If in "0xFFRRGGBB" format, convert to "#RRGGBB"
...
*/		
	...
	public void showSelectPairPopup() {
		...
		switch (mMenuName) {
			...
			break;
			case "textview":
			idList = widgetHelper.getIdsByType("TextView");
			break;
			case "button":
