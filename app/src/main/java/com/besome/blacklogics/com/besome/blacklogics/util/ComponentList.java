...
public class ComponentList {
    public static ArrayList<ComponentData> getComponents() {
        ...
        components.add(new ComponentData("Timer", "Timer is used to delay certain actions", "https://developer.android.com/reference/java/util/Timer"));
        ...
        // Camera and FilePicker related components
        components.add(new ComponentData("Camera", "Captures photos and videos.", "https://developer.android.com/guide/topics/media/camera"));
        components.add(new ComponentData("Camera2 API", "Modern camera API for advanced controls.", "https://developer.android.com/reference/android/hardware/camera2/package-summary"));
        components.add(new ComponentData("FilePicker", "Allows user to select files from device storage.", "https://developer.android.com/training/secure-file-sharing/request-access"));
        components.add(new ComponentData("Storage Access Framework", "Framework to browse and open documents, images, etc.", "https://developer.android.com/guide/topics/providers/document-provider"));
        ...
        components.add(new ComponentData("TelephonyManager", "Provides access to information about telephony services.", "https://developer.android.com/reference/android/telephony/TelephonyManager"));
