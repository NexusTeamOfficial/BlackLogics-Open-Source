package com.nexusteam.sdk.activities.tools;
...
public class ConfigActivity extends Activity {
    ...
    private void initialize() {
        ...
        addTextInputPreference("Backup directory",
                "The default directory is /Internal storage/.blacklogics/backups/.", new View.OnClickListener() {
                    @Override
    ...
    private void addSwitchPreference(final String title, String subtitle, final String keyName, boolean defaultValue) {
        final LinearLayout preferenceRoot = new LinearLayout(this);
