package com.nexusteam.sdk.activity;
...
import com.nexusteam.sdk.lib.code_editor.CodeEditorLayout;
import com.nexusteam.sdk.lib.code_editor.ColorScheme;

public class SrcCodeEditor extends Activity {
    private CodeEditorLayout codeEditor;

    private final View.OnClickListener changeTextSize = new View.OnClickListener() {
        @Override
                ...
                .setPositiveButton(R.string.common_word_save,
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            FileUtil.writeFile(
                                getIntent().getStringExtra("content"), codeEditor.getText());
                            Toast.makeText(SrcCodeEditor.this, "File saved", Toast.LENGTH_SHORT)
                                .show();
                            finish();
                        }
                    })
