package com.besome.blacklogics.tools;
...
import com.nexusteam.sdk.util.CompileLogHelper;
...
public class CompileLogActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compile_log_build);
        ...
        final ImageView menu = findViewById(R.id.ig_toolbar_load_file);
        ...
        if (compileErrorSaver.logFileExists()) {
            ...
            dpToPx(CompileLogActivity.this, 40),
            dpToPx(CompileLogActivity.this, 40)));
            delete.setPadding(
            dpToPx(CompileLogActivity.this, 9),
            dpToPx(CompileLogActivity.this, 9),
            dpToPx(CompileLogActivity.this, 9),
            dpToPx(CompileLogActivity.this, 9)
            );
        ...
        final PopupMenu options = new PopupMenu(this, menu);
