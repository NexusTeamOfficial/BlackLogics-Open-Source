...
public class LayoutBean extends jo implements Parcelable {
    ...
    public boolean isEqual(LayoutBean layoutBean) {
        ...
        if (this.backgroundResource != null) {
            if (layoutBean.backgroundResource == null || !this.backgroundResource.equals(layoutBean.backgroundResource)) {
                return false;
            }
            return true;
