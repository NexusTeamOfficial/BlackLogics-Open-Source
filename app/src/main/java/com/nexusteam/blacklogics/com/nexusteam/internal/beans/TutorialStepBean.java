...
public class TutorialStepBean extends jo implements Parcelable {
    ...
    public TutorialStepBean() {
        ...
        this.descSize = 16;
        this.failedMessage = "";
        this.failedTooltipTextColor = SupportMenu.CATEGORY_MASK;
        this.delayAfter = 0;
    }
    ...
    public void addPermitOption(int i, int i2, Object obj) {
        int i3 = this.permittedOption % 16;
        int i4 = (this.permittedOption >> 4) % 16;
        int i5 = ((this.permittedOption >> 4) >> 4) % 16;
        if (i == 0) {
            i3 = i2;
        } else if (i == 1) {
            i4 = i2;
        ...
        this.permittedOption = (i4 << 4) | i3 | ((i5 << 4) << 4);
    ...
    private boolean isPermitted(int index, Object value) {
        if (value == null) {
            return false;
        }
        
        int option = getPermitOption(index);
        Object permitted = permittedValue[index];
        

        if (com.nexusteam.internal.kx.a(value.toString()) && com.nexusteam.internal.kx.a(permitted.toString())) {
            double v = Double.parseDouble(value.toString());
            double p = Double.parseDouble(permitted.toString());
        ...
        if (value instanceof int[] && permitted instanceof int[]) {
            int[] vArr = (int[]) value;
            int[] pArr = (int[]) permitted;
            
            if (vArr.length != pArr.length) {
                return false;
            }
        ...
        if ((option & 1) == 1 && permitted.equals(value)) {
            return true;
        }
        

        if ((option & 6) == 6 && !permitted.equals(value)) {
            return true;
        }
