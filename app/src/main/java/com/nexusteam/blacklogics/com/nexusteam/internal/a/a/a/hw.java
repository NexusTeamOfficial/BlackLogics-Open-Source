...
public class hw extends AppCompatEditText implements hq {
    ...
    public void a(Context context) {
        ...
        this.f283a.setColor(-1785080368);
    ...
    public void onDraw(Canvas canvas) {
        if (this.c) {
            canvas.drawRect(new Rect(0, 0, getMeasuredWidth(), getMeasuredHeight()), this.f283a);
        }
        super.onDraw(canvas);
    }
}
