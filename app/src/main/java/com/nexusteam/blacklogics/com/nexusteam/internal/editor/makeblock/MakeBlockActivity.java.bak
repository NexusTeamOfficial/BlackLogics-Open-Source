...
public class MakeBlockActivity extends BaseAppCompatActivity {
    ...
    private MoreBlockRepository moreBlockRepo;
    ...
    public void onCreate(Bundle bundle) {
        ...
        moreBlockRepo = MoreBlockRepository.getInstance();
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        if (menuItem.getItemId() == R.id.moreblock_create) {
            ...
            if (this.d.a()) {
                ...
                MoreBlock newBlock = new MoreBlock(blockName, blockSpec);
                

                List<BlockParameter> params = moreBlockRepo.parseBlockSpec(blockSpec);
                newBlock.setParameters(params);
                

                moreBlockRepo.addMoreBlock(f1118a, b.getActivityName(), newBlock);
