...
public class BlockArg extends BlockBase {
    ...
    public BlockArg(Context var1, String var2, int var3, String var4) {
        ...
        if (ProjectDataHelper.getScId(var1) != null && !ProjectDataHelper.getScId(var1).isEmpty()) {
            this.complex.setId(ProjectDataHelper.getScId(var1));
            isMain = ProjectDataHelper.getActivityName(var1).equals("MainActivity");
        ...
        if (ProjectDataHelper.getActivityName(var1) != null) {
            String projectDataDir = com.nexusteam.internal.fe.d(ProjectDataHelper.getScId(var1));
            widgetHelper = new xr(projectDataDir, ProjectDataHelper.getActivityName(var1));
            Qf.setPath("/storage/emulated/0/.blacklogics/data/" + ProjectDataHelper.getScId(var1));
        }
    }
...
this.setBackgroundColor(this.mColor); 
    ...
    private void showColorPopup() {
        ...
        int initialColor = Color.BLACK; // default color
        Object var2 = this.argValue;
        
        if (var2 != null) {
            String argStr = var2.toString().trim();
            

            if (argStr.matches("^0xFF[0-9A-Fa-f]{6}$")) {
                argStr = "#" + argStr.substring(4); // remove 0xFF
            }
            

            if (argStr.startsWith("#")) {
                try {
                    initialColor = Color.parseColor(argStr); // returns 32-bit int
        ...
        ColorPicker colorPicker = new ColorPicker(this.getContext(), false);
        ...
        colorPicker.setOnColorPickedListener(new OnColorPickedListener() {
            ...
            public void onColorPicked(String str) {
                try {
                    ...
                    String colorStr = str.startsWith("#") ? str : "#" + str;
                    
                    setArgValue(colorStr); // save as "#RRGGBB"
    ...
    private void showImagePopup() {
        View var1 = LayoutUtil.inflate(this.getContext(), R.layout.property_popup_selector_color1);
        Builder var2 = new Builder(this.getContext());
        var2.setView(var1);
        var2.setTitle(this.getResources().getString(R.string.title_popup_select_image));
        final RadioGroup var5 = (RadioGroup) var1.findViewById(R.id.rg);
    ...
    public void showEditPopup(final boolean var1) {
        View var2 = LayoutUtil.inflate(this.getContext(), R.layout.property_popup_input_text1);
...
*/        
    ...
    public void showIntentDataPopup() {
        View var1 = LayoutUtil.inflate(this.getContext(), R.layout.property_popup_input_intent_data1);
        final Builder var2 = new Builder(this.getContext());
        var2.setView(var1);
        var2.setTitle(this.getResources().getString(R.string.title_popup_input_data_value));
        final EditText var5 = (EditText)var1.findViewById(R.id.ed_input);
        var5.setInputType(1);
    ...
    public void showPopup() {
        if (this.mType.equals("d")) {
            ...
            !this.mMenuName.equals("button") && !this.mMenuName.equals("materialbutton") && 
            !this.mMenuName.equals("imageview") && !this.mMenuName.equals("imagebutton") && 
            !this.mMenuName.equals("edittext") && !this.mMenuName.equals("checkbox") && 
            !this.mMenuName.equals("switch") && !this.mMenuName.equals("radiobutton") && 
            !this.mMenuName.equals("radiogroup") && !this.mMenuName.equals("listview") && 
            !this.mMenuName.equals("recyclerview") && !this.mMenuName.equals("spinner") && 
            !this.mMenuName.equals("seekbar") && !this.mMenuName.equals("slider") && 
            !this.mMenuName.equals("fab") && !this.mMenuName.equals("bottomnav") && 
            !this.mMenuName.equals("datepicker") && !this.mMenuName.equals("timepicker") && 
            !this.mMenuName.equals("calendar") && !this.mMenuName.equals("cardview") && 
            !this.mMenuName.equals("materialcard") && !this.mMenuName.equals("constraintlayout") && 
            !this.mMenuName.equals("linearlayout") && !this.mMenuName.equals("relativelayout") && 
            !this.mMenuName.equals("framelayout") && !this.mMenuName.equals("scrollview") && 
            !this.mMenuName.equals("horizontalscroll") && !this.mMenuName.equals("nestedscroll") && 
            !this.mMenuName.equals("progressbar") && !this.mMenuName.equals("ratingbar") && 
            !this.mMenuName.equals("chronometer") && !this.mMenuName.equals("gridview") && 
            !this.mMenuName.equals("videoview") && !this.mMenuName.equals("webview") && 
            !this.mMenuName.equals("chip") && !this.mMenuName.equals("toolbar") && 
            !this.mMenuName.equals("materialtoolbar") && !this.mMenuName.equals("collapsingToolbar") && 
            !this.mMenuName.equals("appbar") && !this.mMenuName.equals("swiperefresh") && 
            !this.mMenuName.equals("textinputlayout") && !this.mMenuName.equals("navigationview") && 
            !this.mMenuName.equals("drawablelayout") && !this.mMenuName.equals("motionlayout") && 
            !this.mMenuName.equals("viewpager") && !this.mMenuName.equals("tablayout") && 
            !this.mMenuName.equals("listSpn") && !this.mMenuName.equals("containers") && 
            !this.mMenuName.equals("materialcomponents") && !this.mMenuName.equals("inputWidgets") &&
            !this.mMenuName.equals("toggleWidgets")) {
    ...
    public void showSelectPairPopup() {
        View var1 = LayoutInflater.from(this.getContext()).inflate(R.layout.property_popup_selector_single1, null);
        ...
        switch (mMenuName) {
            case "view":
            idList = widgetHelper.getIdsByType("all");
            break;
            case "textview":
            idList = widgetHelper.getIdsByTextViewFamily();
            break;
            case "button":
            idList = widgetHelper.getIdsByType("Button");
            break;
            case "imageview":
            idList = widgetHelper.getIdsByType("ImageView");
            break;
            case "edittext":
            idList = widgetHelper.getIdsByType("EditText");
            break;
            case "checkbox":
            idList = widgetHelper.getIdsByType("CheckBox");
            break;
            case "switch":
            idList = widgetHelper.getIdsByType("Switch");
            break;
            case "radiobutton":
            idList = widgetHelper.getIdsByType("RadioButton");
            break;
            case "radiogroup":
            idList = widgetHelper.getIdsByType("RadioGroup");
            break;
            case "listview":
            idList = widgetHelper.getIdsByType("ListView");
            break;
            case "recyclerview":
            idList = widgetHelper.getIdsByType("RecyclerView");
            break;
            case "spinner":
            idList = widgetHelper.getIdsByType("Spinner");
            break;
            case "seekbar":
            idList = widgetHelper.getIdsByType("SeekBar");
            break;
            case "slider":
            idList = widgetHelper.getIdsByType("Slider");
            break;
            case "bottomnav":
            idList = widgetHelper.getIdsByType("BottomNavigationView");
            break;
            case "fab":
            idList = widgetHelper.getIdsByType("FloatingActionButton");
            break;
            case "datepicker":
            idList = widgetHelper.getIdsByType("DatePicker");
            break;
            case "timepicker":
            idList = widgetHelper.getIdsByType("TimePicker");
            break;
            case "cardview":
            idList = widgetHelper.getIdsByType("CardView");
            break;
            case "constraintlayout":
            idList = widgetHelper.getIdsByType("ConstraintLayout");
            break;
            case "viewpager":
            idList.addAll(widgetHelper.getIdsByType("ViewPager"));
            idList.addAll(widgetHelper.getIdsByType("ViewPager2"));
            break;
            case "tablayout":
            idList = widgetHelper.getIdsByType("TabLayout");
            break;
            case "progressbar":
            idList = widgetHelper.getIdsByType("ProgressBar");
            break;
            case "videoview":
            idList = widgetHelper.getIdsByType("VideoView");
            break;
            case "webview":
            idList = widgetHelper.getIdsByType("WebView");
            break;
            case "chip":
            idList.addAll(widgetHelper.getIdsByType("Chip"));
            idList.addAll(widgetHelper.getIdsByType("ChipGroup"));
            break;
            case "toolbar":
            idList.addAll(widgetHelper.getIdsByType("Toolbar"));
            idList.addAll(widgetHelper.getIdsByType("MaterialToolbar"));
            break;
            case "collapsingToolbar":
            idList = widgetHelper.getIdsByType("CollapsingToolbarLayout");
            break;
            case "appbar":
            idList = widgetHelper.getIdsByType("AppBarLayout");
            break;
            case "nestedscroll":
            idList = widgetHelper.getIdsByType("NestedScrollView");
            break;
            case "swiperefresh":
            idList = widgetHelper.getIdsByType("SwipeRefreshLayout");
            break;
            case "calendar":
            idList = widgetHelper.getIdsByType("CalendarView");
            break;
            case "textinputlayout":
            idList = widgetHelper.getIdsByType("TextInputLayout");
            break;
            case "navigationview":
            idList = widgetHelper.getIdsByType("NavigationView");
            break;
            case "drawablelayout":
            idList = widgetHelper.getIdsByType("DrawerLayout");
            break;
            case "motionlayout":
            idList = widgetHelper.getIdsByType("MotionLayout");
            break;
            case "imagebutton":
            idList = widgetHelper.getIdsByType("ImageButton");
            break;
            case "materialbutton":
            idList = widgetHelper.getIdsByType("MaterialButton");
            break;
            case "materialcard":
            idList = widgetHelper.getIdsByType("MaterialCardView");
            break;
            case "linearlayout":
            idList = widgetHelper.getIdsByType("LinearLayout");
            break;
            case "relativelayout":
            idList = widgetHelper.getIdsByType("RelativeLayout");
            break;
            case "framelayout":
            idList = widgetHelper.getIdsByType("FrameLayout");
            break;
            case "scrollview":
            idList = widgetHelper.getIdsByType("ScrollView");
            break;
            case "horizontalscroll":
            idList = widgetHelper.getIdsByType("HorizontalScrollView");
            break;
            case "materialcomponents":
            idList.addAll(widgetHelper.getIdsByType("MaterialButton"));
            idList.addAll(widgetHelper.getIdsByType("MaterialCardView"));
            idList.addAll(widgetHelper.getIdsByType("MaterialToolbar"));
            idList.addAll(widgetHelper.getIdsByType("TextInputLayout"));
            break;
            case "containers":
            idList.addAll(widgetHelper.getIdsByType("ConstraintLayout"));
            idList.addAll(widgetHelper.getIdsByType("LinearLayout"));
            idList.addAll(widgetHelper.getIdsByType("RelativeLayout"));
            idList.addAll(widgetHelper.getIdsByType("FrameLayout"));
            break;
            case "listSpn":
            idList.addAll(widgetHelper.getIdsByType("ListView"));
            idList.addAll(widgetHelper.getIdsByType("Spinner"));
            break;
            case "inputWidgets":
            idList.addAll(widgetHelper.getIdsByType("EditText"));
            idList.addAll(widgetHelper.getIdsByType("TextInputEditText"));
            idList.addAll(widgetHelper.getIdsByType("AutoCompleteTextView"));
            break;
            case "toggleWidgets":
            idList.addAll(widgetHelper.getIdsByType("CheckBox"));
            idList.addAll(widgetHelper.getIdsByType("Switch"));
            idList.addAll(widgetHelper.getIdsByType("ToggleButton"));
            break;
        }
...
var2.setPositiveButton(R.string.btn_accept, new DialogInterface.OnClickListener() {
    ...
    public void showSelectPopup() {
        View var1 = LayoutUtil.inflate(this.getContext(), R.layout.property_popup_selector_single1);
        Builder var2 = new Builder(this.getContext());
        var2.setView(var1);
        ...
        if(this.mMenuName.equals("varInt")) {
        ...
        } else if (this.mMenuName.equals("menuAction")) {
            var2.setTitle("Select menu action");
            var4 = new ArrayList(Arrays.asList(DefineSource.MENU_ACTION_FIELD));
            ...
            var4 = new ArrayList<>();
            List<HashMap<String, String>> intentComponents = Qf.loadIntentComponents(ProjectDataHelper.getActivityName(mContext));
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> timerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "Timer");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> dialogComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "Dialog");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> objectAnimatorComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "ObjectAnimator");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> sharedPreferencesComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "SharedPreferences");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> datePickerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "DatePickerDialog");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> timePickerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "TimePickerDialog");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> progressDialogComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "ProgressDialog");
            ...
            var2.setTitle("Select alert dialog component");
            var4 = new ArrayList<>();
            List<HashMap<String, String>> alertDialogComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "AlertDialog");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_vibrator_description));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> vibratorComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "Vibrator");
            ...
            var2.setTitle("Select notification component");
            var4 = new ArrayList<>();
            List<HashMap<String, String>> notificationComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "Notification");
            ...
            var2.setTitle("Select location manager component");
            var4 = new ArrayList<>();
            List<HashMap<String, String>> locationManagerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "LocationManager");
            ...
            var2.setTitle("Select media player component");
            var4 = new ArrayList<>();
            List<HashMap<String, String>> mediaPlayerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "MediaPlayer");
            ...
            var2.setTitle("Select sensor manager component");
            var4 = new ArrayList<>();
            List<HashMap<String, String>> sensorManagerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "SensorManager");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> toastComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "Toast");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> alarmManagerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "AlarmManager");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> bluetoothAdapterComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "BluetoothAdapter");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> wifiManagerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "WifiManager");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> cameraComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "Camera");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> clipboardManagerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "ClipboardManager");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> powerManagerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "PowerManager");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> connectivityManagerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "ConnectivityManager");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> audioManagerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "AudioManager");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> sensorComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "Sensor");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> mediaRouterComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "MediaRouter");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> telecomManagerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "TelecomManager");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> shortcutManagerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "ShortcutManager");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> mediaProjectionManagerComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "MediaProjectionManager");
            ...
            var2.setTitle(this.getResources().getString(R.string.title_popup_select_intent_component));
            var4 = new ArrayList<>();
            List<HashMap<String, String>> biometricPromptComponent = Qf.loadComponentFromName(ProjectDataHelper.getActivityName(mContext), "BiometricPrompt");
