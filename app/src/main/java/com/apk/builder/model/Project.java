...
public class Project {
    ...
    private File mWorkingDirectory; // New field for working directory
    ...
    public void setResourcesFiles(List<File> files) {
        mResourcesFiles = new ArrayList<>(files != null ? files : new ArrayList<>());
        if (mLogger != null) {
    ...
    public String getPackageName() {
        return mBuildSettings.getPackageName();
    }

    public void setPackageName(String name) {
        mBuildSettings.setPackageName(name);
    }
    ...
    public File getWorkingDirectory() {
        if (mWorkingDirectory == null) {
            // Fallback to output directory or app's files directory if not set
            mWorkingDirectory = mOutputFile != null ? mOutputFile : new File(System.getProperty("java.io.tmpdir"));
            if (mLogger != null) {
                mLogger.w("Project", "Working directory not set, using fallback: " + mWorkingDirectory.getAbsolutePath());
            }
        }
        if (mLogger != null) {
            mLogger.d("Project", "Returning working directory: " + mWorkingDirectory.getAbsolutePath());
        }
    ...
    public void setWorkingDirectory(File workingDirectory) {
        ...
        if (mLogger != null) {
            mLogger.d("Project", "Set working directory to: " + workingDirectory.getAbsolutePath());
        }
    }
