...
/*
    ...
    public void show() {
        ...
        editor.setVerticalScrollBarEnabled(true); // Replaced setOverScrollEnabled
        ...
        switch (title) {
            ...
            case "Switch language":
                new AlertDialog.Builder(c)
                        ...
                        .setSingleChoiceItems(new String[] {"C", "C++", "Java", "JavaScript", "None"}, -1, (dialog, which) -> {
